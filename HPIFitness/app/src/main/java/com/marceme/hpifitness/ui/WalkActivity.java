...
//                    user.setPace((float) (Helper.calculatePace(timeWalked,distanceWalked)/1000.0)); km/p
    ...
    private void updateUI() {
        if (isServiceBound) {
            mDistanceTextView.setText(String.valueOf(mLocationService.distanceCovered()/1000.0)+" KM");
